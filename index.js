...
function validate() {
    ...
    if( document.enterform.year.value == "" || document.enterform.year.value.length !=4 || document.enterform.year.value >2100 || document.myForm.year.value <=1900) {
       alert( "Not valid!" );document.enterform.year.focus() ;
       return false;}
